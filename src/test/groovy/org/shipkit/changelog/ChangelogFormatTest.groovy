...
class ChangelogFormatTest extends Specification {
    ...
    def "creates changelog"() {
        def improvements = [
                new Improvement(11, "fixed bug", "https://github.com/myorg/myrepo/pulls/11", [], true),
                new Improvement(12, "improved feature", "https://github.com/myorg/myrepo/issues/12", [], false),
        ]
        when:
